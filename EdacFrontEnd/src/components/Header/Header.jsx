      ...
      <div className="container">
        ...
        <div className="main-navigation">
          ...
          <ul className="menu">
            ...
            {/* <li className="menu-item"><Link to="/student">Student Login</Link></li>
            <li className="menu-item"><Link to="/faculty">Faculty Login</Link></li> */}
            <li className="menu-item"><Link to="/admin/logout">LogOut</Link></li>
            {/* <li className="menu-item"><input>LogOut</input></li> */}
          </ul>
        </div>
